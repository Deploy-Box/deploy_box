...
class AzurermStorageAccount(BaseResourceModel):
	...
	def save(self, *args, **kwargs):
		...
		if environment == 'prod':
			self.azurerm_name = f"sa{self.index}{self.stack.pk}"
		else:
			self.azurerm_name = f"sa{self.index}{self.stack.pk}{environment}"
