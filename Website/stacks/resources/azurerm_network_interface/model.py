...
class AzurermNetworkInterface(BaseResourceModel):
	...
	ip_configuration_name = models.CharField(max_length=255, default='internal')
	subnet_id = models.CharField(max_length=255)
	private_ip_address_allocation = models.CharField(max_length=50, default='Dynamic')
	public_ip_address_id = models.CharField(max_length=255, blank=True, default='')
